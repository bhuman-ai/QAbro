  ...
  const challenges = await page.evaluate(() => {
    ...
    const pushChallenge = (candidate) => {
      ...
      items.push({
        ...
        callback_name: textFrom(candidate?.callback_name) || null,
        data_s: textFrom(candidate?.data_s) || null,
        action: textFrom(candidate?.action) || null,
        data: textFrom(candidate?.data) || null,
        pagedata: textFrom(candidate?.pagedata) || null,
        invisible: candidate?.invisible === true,
        enterprise: candidate?.enterprise === true
      });
    };
