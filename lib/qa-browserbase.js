...
const { actionParser: parseUiTarsAction } = require("@ui-tars/action-parser");
...
function resolveCoordinateClickFallbackConfig(options = {}) {
  ...
  const uiTarsApiKey = sanitizeString(
  ...
  const uiTarsClient =
    typeof options.coordinateUiTarsClient === "function" ? options.coordinateUiTarsClient : null;
